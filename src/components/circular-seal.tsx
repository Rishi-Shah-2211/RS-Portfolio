...
export default function CircularSeal({
  ...
  return (
    <div className={`relative ${className}`} aria-hidden>
      ...
      <div className="absolute inset-[10%] rounded-full bg-[radial-gradient(circle,rgba(110,39,70,0.12)_0%,rgba(173,135,84,0.1)_45%,transparent_70%)] blur-2xl" />
      <div className="absolute inset-[28%] rounded-full bg-[radial-gradient(circle,rgba(216,188,203,0.22)_0%,rgba(110,39,70,0.1)_55%,transparent_80%)] blur-xl" />
      ...
      <div className="absolute left-1/2 top-1/2 h-[14%] w-[14%] -translate-x-1/2 -translate-y-1/2 rounded-full">
        ...
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-peach via-terracotta to-terracotta-deep shadow-[inset_-6px_-8px_18px_rgba(10,16,35,0.5),inset_6px_8px_18px_rgba(235,238,248,0.5),0_25px_50px_-12px_rgba(110,39,70,0.4)]" />
      ...
      >
        <div className="absolute left-1/2 top-0 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-terracotta shadow-[0_0_14px_rgba(110,39,70,0.6)]" />
      </motion.div>
    </div>
  );
}
