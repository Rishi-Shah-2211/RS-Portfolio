  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
        ...
        {/* Publication */}
        <Reveal delay={0.2}>
          <div className="mt-20 grid gap-6 rounded-md border border-ink/10 bg-cream-dim/55 p-8 shadow-[0_28px_80px_-48px_rgba(20,90,67,0.24)] backdrop-blur md:grid-cols-12 md:p-10">
            <div className="md:col-span-3">
