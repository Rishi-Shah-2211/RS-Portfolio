  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Magnetic>
              <a
                ...
                data-cursor="email"
                className="shimmer group inline-flex items-center gap-3 rounded-full bg-cream px-7 py-4 font-mono text-xs uppercase tracking-[0.2em] text-ink"
              >
            ...
            <a
              ...
              data-cursor="call"
              className="inline-flex items-center gap-3 rounded-full border border-cream/30 px-7 py-4 font-mono text-xs uppercase tracking-[0.2em] text-cream/90 transition-colors hover:bg-cream/10"
            >
              +91 90230 80466
            </a>
          </div>
        ...
        <Reveal delay={0.45}>
          <div className="mt-20 grid gap-10 border-t border-cream/15 pt-10 md:grid-cols-3">
            {SOCIALS.map((s) => (
              <a
                key={s.label}
                href={s.href}
                ...
                className="group flex items-baseline justify-between gap-4 border-b border-cream/15 pb-4 transition-colors hover:border-peach"
              >
                <div>
                  <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-cream/50">
                    {s.label}
                  </p>
                  <p className="mt-2 font-display text-2xl text-cream transition-colors group-hover:text-peach">
                    {s.handle}
                  </p>
                </div>
                <span className="inline-block text-cream/60 transition-transform duration-500 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-peach">
                  ↗
                </span>
              </a>
            ))}
